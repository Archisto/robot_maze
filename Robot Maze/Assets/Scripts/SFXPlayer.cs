...
namespace RobotMaze
{
    ...
    public class SFXPlayer : MonoBehaviour
    {
        ...
        public AudioSource Play(Sound sound, bool loop)
        {
            return Play((int) sound, loop);
        }
        ...
        public AudioSource Play(int soundNum, bool loop)
        {
            if (soundNum >= 0 &&
                soundNum < sounds.Count)
            {
                ...
                // Plays the sound
                return Play(sounds[soundNum], loop);
        ...
        private AudioSource Play(AudioClip clip, bool loop)
        {
